      ...
      <div className="flex flex-col space-y-2 text-center">
        ...
        <div>
          <div className="text-sm">
            {showSuccess ? (
              <>
                <p>You've managed to protect your device from threats on your own!</p>
                <p>Good luck with that, but there is a better way</p>
              </>
            ) : (
              <>
                <p>It's better to rely on professionals when <br /> it comes to protecting your device from threats.</p>
              </>
            )}
          </div>
